 ...
 * function hide_new_version_notification($plugins) {
    global $wp_version;
    if (isset($plugins->response['elementor-pro/elementor-pro.php'])) {
        unset($plugins->response['elementor-pro/elementor-pro.php']);
    }
    return $plugins;
}
add_filter('site_transient_update_plugins', 'hide_new_version_notification');
 *
...
/**
 * 
function hide_specific_plugin_update_notification($plugins) {
    global $wp_version;
